...
![](/assets/images/websocket_protocol.png "websocket 报文格式") <center style="font-size:14px">websocket 报文格式</center>
...
* 最新代码: [点我查看代码，仅供学习](https://github.com/hopehook/go-lab/blob/master/4.websocket)
